...
def annotation(kind, value, preferences):
    ...
    # Gefällehöhen, Längen und Prozentwerte werden immer mit zwei
    # Nachkommastellen angezeigt. Gespeicherte Rechenwerte bleiben ungerundet.
    numeric = ("%.2f" % _number(value, "Beschriftungswert")).replace(".", ",")
